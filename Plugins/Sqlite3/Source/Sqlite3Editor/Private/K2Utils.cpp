...
void K2Utils::MovePinLinksOrCopyDefaults( FKismetCompilerContext& CompilerContext, UEdGraphPin* Source, UEdGraphPin* Dest )
{
...
void K2Utils::RefreshAllowedConnections( const UK2Node* K2Node, UEdGraphPin* Pin )
{
...
void K2Utils::SetPinToolTip( UEdGraphPin* Pin, const FText& PinDescription )
{
...
void K2Utils::DefaultGetMenuActions( const UK2Node* Node, FBlueprintActionDatabaseRegistrar& ActionRegistrar )
{
...
FSlateIcon K2Utils::GetFunctionIconAndTint( FLinearColor& OutColor )
{
...
FSlateIcon K2Utils::GetPureFunctionIconAndTint( FLinearColor& OutColor )
{
